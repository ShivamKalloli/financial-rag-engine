...
from app.security.input_validator import sanitize_question, validate_retrieval_mode, validate_top_k
...
class RAGPipeline:
    ...
    def query(
        ...
        model_used = chain.model_used if hasattr(chain, "model_used") else settings.llm_backend
